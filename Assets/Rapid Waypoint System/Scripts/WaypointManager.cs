...
public class WaypointManager : MonoBehaviour {
    ...
    internal void RemoveEntity(EnemyMovement enemyMovement)
    {
        throw new NotImplementedException();
    }

    internal bool ObjectIsOnNode(EnemyMovement enemyMovement)
    {
        throw new NotImplementedException();
    }
    ...
    private GameObject SpawnEntity(GameObject objectToSpawn)
    {
        ...
        Vector3 targetPosition = new Vector3(((UnityEngine.Random.insideUnitSphere.x * 2) * nodeProximityDistance),
                                                        0 + (objectToSpawn.GetComponent<Collider>().bounds.extents.magnitude) / 2,
                                                        ((UnityEngine.Random.insideUnitSphere.z * 2) * nodeProximityDistance));
